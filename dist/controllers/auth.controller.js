...
exports.debugLogin = exports.getMe = exports.loginWithMicrosoft = exports.login = void 0;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let user;
        try {
            user = yield User_1.default.findOne({ email: normalizedEmail });
        }
        catch (dbError) {
...
const loginWithMicrosoft = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
